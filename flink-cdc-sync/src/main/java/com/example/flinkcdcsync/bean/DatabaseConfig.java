...
public class DatabaseConfig implements Serializable {
     ...
     * @return 连接测试结果
     */
    public com.example.flinkcdcsync.common.ConnectionTestResult testConnection() {
        String url = getDBURL();
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Properties props = new Properties();
            ...
            try (Connection conn = DriverManager.getConnection(url, props)) {
                ...
                if (valid) {
                    return com.example.flinkcdcsync.common.ConnectionTestResult.ok(url);
                }
                return com.example.flinkcdcsync.common.ConnectionTestResult.fail(url, "连接已建立但 isValid() 返回 false");
            }
        } catch (Exception e) {
            return com.example.flinkcdcsync.common.ConnectionTestResult.fail(url, e.getMessage());
        }
    }
     ...
     * @return 连接测试结果
     */
    public com.example.flinkcdcsync.common.ConnectionTestResult testServerConnection() {

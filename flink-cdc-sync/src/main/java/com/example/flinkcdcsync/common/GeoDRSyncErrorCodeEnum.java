 ...
 */
@Getter
public enum GeoDRSyncErrorCodeEnum {
    ...
    GeoDRSyncErrorCodeEnum(String code, String message, int httpStatus, boolean retryable) {
        this.code = code;
    ...
    public static String getMessageByCode(String code) {
        ...
        for (GeoDRSyncErrorCodeEnum e : values()) {
    ...
    public static GeoDRSyncErrorCodeEnum getByCode(String code) {
        if (code == null) {
            return null;
        }
        for (GeoDRSyncErrorCodeEnum e : values()) {
    ...
    /** 抛出业务异常 */
    public static void throwException(GeoDRSyncErrorCodeEnum e) {
        throw new BusinessException(e.getCode(), e.getMessage());
    }

    /** 抛出业务异常（带自定义消息） */
    public static void throwException(GeoDRSyncErrorCodeEnum e, String customMessage) {

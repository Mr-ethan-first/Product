...
function Select({
  ...
  return React.createElement("div", {
    ...
    className: "rx-ph"
  }, placeholder), vals.map(v => React.createElement("span", {
    key: v,
    className: "rx-tag"
  }, v, multiple && React.createElement("span", {
    className: "rx-x",
    onClick: e => {
      e.stopPropagation();
      toggle(v);
    }
  }, "\xD7"))), open && filterable && React.createElement("input", {
    className: "rx-input",
    autoFocus: true,
    value: text,
    ...
    onClick: () => toggle(o)
  }, o)), showCreate && React.createElement("div", {
...
function App() {
  ...
  if (!authed) {
    ...
    }, React.createElement("h2", null, "GeoDRSync \u7BA1\u7406\u540E\u53F0"), React.createElement("div", {
      className: "tip"
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    className: "title"
  }, "GeoDRSync \xB7 \u5730\u7406\u6570\u636E\u5E93\u707E\u5907\u540C\u6B65\u670D\u52A1"), React.createElement("div", {
    className: "sub"
    ...
    className: "v info"
  }, "geodrsync")))), React.createElement("div", {
    className: "card"
    ...
    value: ""
  }, "\u72B6\u6001"), React.createElement("option", {
    value: "0"
  }, "\u5931\u6548"), React.createElement("option", {
    value: "1"
  }, "\u5168\u91CF\u540C\u6B65"), React.createElement("option", {
    value: "2"
  }, "\u540C\u6B65\u4E2D"), React.createElement("option", {
    value: "3"
  }, "\u4E2D\u6B62")), React.createElement("button", {
    className: "rx-btn rx-btn-primary",
    onClick: search
    ...
    value: ""
  }, "\u5168\u90E8"), logTypes.map(t => React.createElement("option", {
    key: t,
    value: t
    ...
    value: ""
  }, "\u5168\u90E8"), React.createElement("option", {
    value: "SUCCESS"
  }, "\u6210\u529F"), React.createElement("option", {
    value: "FAILURE"
    ...
    className: "rx-label"
  }, "\u5F00\u59CB\u65F6\u95F4"), React.createElement("input", {
    type: "datetime-local",
    className: "rx-input",
    style: {
      border: '1px solid #dcdfe6',
    ...
    className: "rx-label"
  }, "\u7ED3\u675F\u65F6\u95F4"), React.createElement("input", {
    type: "datetime-local",
    className: "rx-input",
    style: {
      border: '1px solid #dcdfe6',
  ...
  }, row.durationMs ?? '—'), React.createElement("td", {
    style: {
      fontFamily: 'monospace',
      fontSize: 12
    }
    ...
    className: "footer"
  }, "GeoDRSync \xB7 \u672C\u5730\u5185\u5D4C\u540C\u6B65\u5F15\u64CE\u6F14\u793A \xB7 \u4E3B\u673A\u5BF9\u81EA\u52A8\u540C\u6B65 + \u5FFD\u7565\u5F0F\u914D\u7F6E + \u5B9E\u65F6\u65B0\u5E93\u65B0\u8868\u76D1\u6D4B")), React.createElement(Drawer, {
    open: drawer,
    title: "\u540C\u6B65\u8BE6\u60C5",

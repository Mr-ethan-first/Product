...
@EnableScheduling
@MapperScan("com.example.remotedatasync.mapper")
public class RemoteDataSyncApplication {

    public static void main(String[] args) {
        // 本系统为中国异地容灾同步，统一使用 Asia/Shanghai 时区，
        // 避免 LocalDateTime.now() 等元数据时间戳落为本机其它时区（如 PDT）。
        TimeZone.setDefault(TimeZone.getTimeZone("Asia/Shanghai"));
        SpringApplication.run(RemoteDataSyncApplication.class, args);
    }
}

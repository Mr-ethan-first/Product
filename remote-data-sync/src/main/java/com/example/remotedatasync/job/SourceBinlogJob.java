...
import com.example.remotedatasync.mapper.SourceLatestBinlogInfoMapper;
import com.example.remotedatasync.po.SourceLatestBinlogInfo;
...
public class SourceBinlogJob {
    ...
    public SourceBinlogJob(DRPlatformProperties properties, DynamicShardedConnectionManager connMgr,

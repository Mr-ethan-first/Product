...
/**
 * DRPlatform 业务配置绑定（前缀 DRPlatform）。
 *
 * @author 50707
 */
@Data
@Component
@ConfigurationProperties(prefix = "drplatform")
public class DRPlatformProperties {
    ...
    public static class Flink {
        ...
        private String savepointPath = "/data/DRPlatform/savepoint";
    }

  ...
  return (
    <div>
      <div className="topbar">
        <div>
          <div className="title">DRPlatform · 地理数据库灾备同步服务</div>
      ...
      <div className="wrap">
          ...
          <div>
            <div className="card">
              ...
              <div className="stat-row">
                ...
                <div className="stat"><div className="k">元数据库</div><div className="v info">DRPlatform</div></div>
              </div>
            </div>
        ...
        <div className="footer">DRPlatform · 本地内嵌同步引擎演示 · 主机对自动同步 + 忽略式配置 + 实时新库新表监测</div>
      </div>
